...
class Database {
    ...
    // Here we defined the values in the db_config.php. We are using it to connect to the database
    // the mysql pool is being stored in connection 
    ...
    // created this method to grab the last id from the database
